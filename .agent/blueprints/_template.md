...
> If a detail is slice-local, command-oriented, or validation-log oriented, it
> belongs in `$PRJ_CACHE_HOME/agent/execplans/`, not here.
...
- Related stable references:
  - `relative/path/to/rfc_or_doc.md`
...
5. migration pressure from legacy surfaces
