#!/usr/bin/env python3
"""
Memory-focused validation suite for xiuxian-daochang Telegram channel/runtime.
...
def parse_args() -> argparse.Namespace:
    return _cli_module.parse_args(
        ...
        default_evolution_output_json=str(
            default_report_path("xiuxian-daochang-memory-evolution.json")
        ),
        default_evolution_output_markdown=str(
            default_report_path("xiuxian-daochang-memory-evolution.md")
        ),
    )
