...
def add_quality_args(parser: Any) -> None:
    ...
    parser.add_argument("--max-tool-call-waiting-events", type=int, default=0)
    parser.add_argument("--max-tool-connect-waiting-events", type=int, default=0)
    parser.add_argument("--max-tool-waiting-events-total", type=int, default=0)
