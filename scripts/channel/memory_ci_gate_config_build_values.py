...
def build_gate_config(
    ...
    *,
    ...
    return gate_config_cls(
        ...
        max_tool_call_waiting_events=int(args.max_tool_call_waiting_events),
        max_tool_connect_waiting_events=int(args.max_tool_connect_waiting_events),
        max_tool_waiting_events_total=int(args.max_tool_waiting_events_total),
