"""Private knowledge benchmark snapshot helpers for benchmark tests."""
...
def default_knowledge_snapshot_path():
    return get_skills_dir() / "_snapshots" / "benchmark" / "knowledge_tools.yaml"
...
def save_knowledge_snapshot(path, payload: dict[str, Any]):
