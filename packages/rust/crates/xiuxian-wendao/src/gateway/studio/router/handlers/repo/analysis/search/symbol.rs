...
use crate::analyzers::service::{build_symbol_search_with_artifacts, repository_search_artifacts};
use crate::analyzers::{RepoIntelligenceError, SymbolSearchQuery};
...
use crate::search_plane::search_repo_entity_symbol_results;
            ...
            move || async move {
                ...
                with_repo_cached_analysis_bundle(
                    ...
                    move |cached| {
                        ...
                        let result = build_symbol_search_with_artifacts(
                            &query,
                            &cached.analysis,
                            artifacts.as_ref(),
                        );
