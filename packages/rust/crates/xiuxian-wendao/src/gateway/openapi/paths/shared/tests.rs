...
use crate::gateway::openapi::paths::{
    ...
    API_UI_COMPAT_DEPLOYMENT_ARTIFACT_OPENAPI_PATH, API_UI_PLUGIN_ARTIFACT_OPENAPI_PATH,
...
fn route_inventory_keeps_core_endpoints() {
    ...
    assert!(openapi_paths.contains(API_UI_COMPAT_DEPLOYMENT_ARTIFACT_OPENAPI_PATH));
}
