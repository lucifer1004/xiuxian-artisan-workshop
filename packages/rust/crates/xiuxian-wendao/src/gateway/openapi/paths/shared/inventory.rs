use crate::gateway::openapi::paths::shared::{
    analysis::*,
    contracts::{
        API_HEALTH_AXUM_PATH, API_HEALTH_OPENAPI_PATH, API_NOTIFY_AXUM_PATH,
        API_NOTIFY_OPENAPI_PATH, API_STATS_AXUM_PATH, API_STATS_OPENAPI_PATH, RouteContract,
    },
    docs::*,
    graph::*,
    repo::*,
