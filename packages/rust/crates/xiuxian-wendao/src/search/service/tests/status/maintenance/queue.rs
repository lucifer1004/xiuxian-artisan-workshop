...
fn status_surfaces_local_compaction_queue_backlog_for_queued_corpus() {
    ...
    assert!(service.publish_ready_and_maintain(&lease, 10, 3));
    {
        ...
        runtime.compaction_queue.push_back(
            crate::search::service::core::QueuedLocalCompactionTask {
                task: crate::search::coordinator::SearchCompactionTask {
                    corpus: SearchCorpusKind::KnowledgeSection,
                    active_epoch: 1,
                    row_count: 8,
                    reason: crate::search::coordinator::SearchCompactionReason::PublishThreshold,
                },
                enqueue_sequence: 0,
            },
        );
        ...
        runtime.compaction_queue.push_back(
            crate::search::service::core::QueuedLocalCompactionTask {
                task: crate::search::coordinator::SearchCompactionTask {
                    ...
                    active_epoch: 1,
                    row_count: 10,
                    reason: crate::search::coordinator::SearchCompactionReason::RowDeltaRatio,
                },
                enqueue_sequence: 0,
            },
        );
