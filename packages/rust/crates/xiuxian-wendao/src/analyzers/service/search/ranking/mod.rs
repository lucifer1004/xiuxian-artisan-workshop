...
pub(crate) use example::ranked_example_matches_with_artifacts;
pub(crate) use module::ranked_module_matches;
#[cfg(all(feature = "studio", feature = "repo-lexical-index"))]
pub(crate) use module::ranked_module_matches_with_artifacts;
...
#[cfg(all(feature = "studio", feature = "repo-lexical-index"))]
pub(crate) use symbol::ranked_symbol_matches_with_artifacts;
