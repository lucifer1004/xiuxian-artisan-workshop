...
pub use query::{
    ...
    ModuleSearchResult, ProjectedPageFamilyCluster, ProjectedPageFamilyContextEntry,
    ...
    RepoOverviewResult, RepoProjectedPageFamilyClusterQuery, RepoProjectedPageFamilyClusterResult,
...
pub use service::{
    ...
    import_search_from_config, import_search_from_config_with_registry, load_registered_repository,
    module_search_from_config, module_search_from_config_with_registry, repo_overview_from_config,
    repo_overview_from_config_with_registry, repo_projected_page_family_cluster_from_config,
