...
async fn local_symbol_query_can_rerank_across_multiple_tables() {
    ...
    store
        .replace_record_batches(
            ...
            crate::search_plane::local_symbol::schema::local_symbol_schema(),
            crate::search_plane::local_symbol::schema::local_symbol_batches(&hits_a)
    ...
    store
        .replace_record_batches(
            ...
            crate::search_plane::local_symbol::schema::local_symbol_schema(),
            crate::search_plane::local_symbol::schema::local_symbol_batches(&hits_b)
