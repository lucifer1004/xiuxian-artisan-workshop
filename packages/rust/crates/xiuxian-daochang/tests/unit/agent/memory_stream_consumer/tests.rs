...
use xiuxian_daochang::test_support::{
    ...
    queue_promoted_candidate, read_stream_events, should_surface_repeated_failure,
    stream_consumer_connection_config, stream_consumer_response_timeout, summarize_redis_error,
};
