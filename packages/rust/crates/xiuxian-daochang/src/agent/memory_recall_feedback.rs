...
pub(crate) const RECALL_FEEDBACK_SOURCE_USER: &str = "user_feedback";
pub(crate) const RECALL_FEEDBACK_SOURCE_TOOL: &str = "tool_execution";
pub(crate) const RECALL_FEEDBACK_SOURCE_ASSISTANT: &str = "assistant_heuristic";
pub(crate) const RECALL_FEEDBACK_SOURCE_COMMAND: &str = "session_feedback_command";

pub(crate) type RecallOutcome = RecallFeedbackOutcome;

pub(crate) fn update_feedback_bias(previous: f32, outcome: RecallOutcome) -> f32 {
...
impl ToolExecutionSummary {
    pub(crate) fn record_result(&mut self, is_error: bool) {
    ...
    pub(crate) fn inferred_outcome(self) -> Option<RecallOutcome> {
        if self.attempted == 0 {
            return None;
        }
...
pub(crate) fn classify_assistant_outcome(message: &str) -> RecallOutcome {
...
pub(crate) fn parse_explicit_user_feedback(message: &str) -> Option<RecallOutcome> {
...
pub(crate) fn resolve_feedback_outcome(
    user_message: &str,
...
pub(crate) fn apply_feedback_to_plan(
