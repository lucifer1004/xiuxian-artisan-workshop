...
impl DiscordChannel {
    /// Create a Discord channel with default admin policy (`admin_users=allowed_users`).
    #[must_use]
    ...
    /// Create a Discord channel with explicit session partition.
    #[must_use]
    ...
    /// Create a Discord channel with explicit control-command policy.
    #[must_use]
    ...
    /// Create a Discord channel with explicit control-command policy and session
    /// partition.
    #[must_use]
