...
impl From<crate::transmuter::streaming::ZhenfaStreamingEvent> for ArcStreamingEvent {
    fn from(event: crate::transmuter::streaming::ZhenfaStreamingEvent) -> Self {
        match event {
            crate::transmuter::streaming::ZhenfaStreamingEvent::Thought(text) => {
                Self::Thought(text)
            }
            crate::transmuter::streaming::ZhenfaStreamingEvent::TextDelta(text) => {
                Self::TextDelta(text)
            }
            crate::transmuter::streaming::ZhenfaStreamingEvent::ToolCall { id, name, input } => {
                Self::ToolCall { id, name, input }
            }
            crate::transmuter::streaming::ZhenfaStreamingEvent::ToolResult { id, output } => {
                Self::ToolResult { id, output }
            }
            crate::transmuter::streaming::ZhenfaStreamingEvent::Status(text) => Self::Status(text),
            crate::transmuter::streaming::ZhenfaStreamingEvent::Progress { message, percent } => {
                Self::Progress { message, percent }
            }
            crate::transmuter::streaming::ZhenfaStreamingEvent::Finished(outcome) => {
                Self::Finished(ArcStreamingOutcome {
            ...
            crate::transmuter::streaming::ZhenfaStreamingEvent::Error { code, message } => {
                Self::Error { code, message }
            }
        }
    }
