...
use super::super::preprocess::PreparedVisionImage;
...
pub(in crate::llm::vision::deepseek) fn valkey_get_with_for_tests(
    valkey_url: &str,
    key_prefix: &str,
    ttl_secs: u64,
    io_timeout_ms: u64,
...
pub(in crate::llm::vision::deepseek) fn valkey_set_with_for_tests(
    valkey_url: &str,
    key_prefix: &str,
    ttl_secs: u64,
    io_timeout_ms: u64,
...
pub(in crate::llm::vision::deepseek) fn normalize_valkey_timeout_ms_for_tests(
    io_timeout_ms: u64,
) -> u64 {
    cache::normalize_valkey_timeout_ms_for_tests(io_timeout_ms)
}

pub(in crate::llm::vision::deepseek) fn local_cache_get_for_tests(key: &str) -> Option<String> {
    cache::local_get(key)
}

pub(in crate::llm::vision::deepseek) fn local_cache_set_with_max_entries_for_tests(
    key: &str,
    markdown: &str,
    max_entries: usize,
) {
...
pub(in crate::llm::vision::deepseek) fn local_cache_clear_for_tests() {
    cache::local_clear_for_tests();
}

pub(in crate::llm::vision::deepseek) fn normalize_cache_text_view_for_tests(
    text: &str,
) -> Option<String> {
    cache::normalize_cache_text_view_for_tests(text)
}

pub(in crate::llm::vision::deepseek) fn normalize_cache_text_owned_for_tests(
    text: String,
) -> Option<String> {
