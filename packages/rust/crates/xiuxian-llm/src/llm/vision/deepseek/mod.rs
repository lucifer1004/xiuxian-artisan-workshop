...
pub(crate) use test_api::load_config_with_paths_for_tests;
#[cfg(feature = "vision-dots")]
pub use test_api::{
    DsqRepairResult, build_cache_key_with_for_tests, cache_layer_labels_for_tests,
    load_deepseek_ocr_for_tests, local_cache_clear_for_tests, local_cache_get_for_tests,
