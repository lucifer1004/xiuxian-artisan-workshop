...
pub use plugin::{
    ...
    build_graph_structural_flight_transport_client, build_julia_flight_transport_client,
    graph_structural_route_kind, is_graph_structural_route,
    ...
    validate_graph_structural_response_batches, validate_julia_arrow_response_batches,
};
