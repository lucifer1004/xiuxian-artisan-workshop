...
pub struct PyDiscoverOptions {
    /// File extensions to include (for example: `.py`, `.md`).
    #[pyo3(get, set)]
    ...
    /// Skip directories by name (for example: `target`, `node_modules`).
    #[pyo3(get, set)]
...
impl PyDiscoverOptions {
    #[new]
    #[pyo3(signature = (extensions, max_file_size = 1_048_576, skip_hidden = true, skip_dirs = None, max_files = None, recursive = true))]
    fn new(
...
/// # Errors
///
/// Returns `PyIOError` when file reading or text decoding fails.
#[pyfunction]
...
#[pyfunction]
#[must_use]
#[pyo3(signature = (root, extensions, max_file_size = 1_048_576, skip_hidden = true, skip_dirs = None, recursive = true))]
...
#[pyfunction]
#[must_use]
#[pyo3(signature = (dir, extensions, max_file_size = 1_048_576, skip_hidden = true))]
