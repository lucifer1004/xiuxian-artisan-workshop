...
def make_tool_search_payload(
    **overrides: Any,
    ...
    """Build a canonical xiuxian.vector.tool_search.v1 payload for tests."""
...
def make_vector_payload(**overrides: Any) -> dict[str, Any]:
    """Build a canonical xiuxian.vector.search.v1 payload for tests."""
    payload: dict[str, Any] = {
...
def make_hybrid_payload(**overrides: Any) -> dict[str, Any]:
    """Build a canonical xiuxian.vector.hybrid.v1 payload for tests."""
    payload: dict[str, Any] = {
...
def make_router_result_payload(
    **overrides: Any,
    ...
    """Build a canonical router result payload for CLI/router tests (xiuxian.router.route_test.v1 result item)."""
    payload: dict[str, Any] = {
        "id": "git.commit",
        "name": "git.commit",
        "description": "Commit changes",
...
def make_db_search_vector_result_list(
    ...
    **item_overrides: Any,
    ...
    """Build a canonical list of xiuxian.vector.search.v1 items (db search vector response)."""
...
def make_db_search_hybrid_result_list(
    ...
    **item_overrides: Any,
    ...
    """Build a canonical list of xiuxian.vector.hybrid.v1 items (db search hybrid response)."""
