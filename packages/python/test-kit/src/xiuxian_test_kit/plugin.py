...
import pytest
from xiuxian_test_kit.decorators import load_test_cases

# Register fixtures from submodules
pytest_plugins = [
    "xiuxian_test_kit.fixtures.memory_protection",  # Must load early: memory cap + per-test abort
    "xiuxian_test_kit.fixtures",
]
