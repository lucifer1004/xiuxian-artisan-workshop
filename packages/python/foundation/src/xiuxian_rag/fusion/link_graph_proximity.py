"""Bridge adapter: fusion entrypoint routed to common LinkGraph engine."""

from __future__ import annotations

from typing import TYPE_CHECKING, Any

from xiuxian_rag.link_graph.proximity import apply_link_graph_proximity_boost
...
async def link_graph_proximity_boost(
    ...
    *,
    ...
    """Thin wrapper around ``xiuxian_rag.link_graph.proximity``."""
