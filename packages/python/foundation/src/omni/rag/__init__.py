...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "apply_kg_recall_boost": (".fusion", "apply_kg_recall_boost"),
    "chunk_text": (".chunking", "chunk_text"),
    "compute_fusion_weights": (".fusion", "compute_fusion_weights"),
    ...
    "enrich_skill_graph_from_link_graph": (".fusion", "enrich_skill_graph_from_link_graph"),
    ...
    "register_skill_entities": (".fusion", "register_skill_entities"),
    "link_graph_proximity_boost": (".fusion", "link_graph_proximity_boost"),
}
