...
Usage:
    from xiuxian_foundation.config import PRJ_DIRS
    from xiuxian_foundation.config.prj import PRJ_DATA, get_cache_dir
    from xiuxian_foundation.config.link_graph import get_link_graph_notebook_dir
