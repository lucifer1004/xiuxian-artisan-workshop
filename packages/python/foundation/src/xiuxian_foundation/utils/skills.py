...
Usage:
    from xiuxian_foundation.skill_utils import current_skill_dir, skill_path
...
def current_skill_dir() -> Path:
    ...
    Example:
        from xiuxian_foundation.skill_utils import current_skill_dir
...
def skill_path(
    ...
    *,
    ...
    Example:
        from xiuxian_foundation.skill_utils import skill_path
...
def skill_command(relative_path: str, *, skill_dir: Path | None = None) -> Path:
    ...
    Example:
        from xiuxian_foundation.skill_utils import skill_command
