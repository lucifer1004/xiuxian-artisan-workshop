...
_skill_command_registry: dict[str, Callable[..., Any]] = {}
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def _record_execution_phase(
            ...
            *,
            ...
            del duration_ms, success, payload
            return None
        ...
        async def _async_run(*args: Any, **kwargs: Any) -> dict[str, Any]:
            ...
            try:
                ...
                normalized = normalize_tool_result(out)
                success = not bool(normalized.get("isError"))
                try:
                    payload = _parse_tool_result_payload(normalized)
                except Exception:
                    payload = None
                if (
                    success
