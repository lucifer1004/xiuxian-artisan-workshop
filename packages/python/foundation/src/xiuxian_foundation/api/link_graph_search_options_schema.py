...
SCHEMA_NAME = "xiuxian_wendao.link_graph.search_options.v2.schema.json"
SCHEMA_VERSION = "xiuxian_wendao.link_graph.search_options.v2"
...
def get_schema_id() -> str:
    ...
    if not schema_id:
        raise ValueError("LinkGraph search options schema missing $id")
    return schema_id
