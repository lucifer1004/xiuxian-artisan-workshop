...
### Core Components
- **packages/rust/crates/xiuxian-daochang/**: runtime and orchestration authority
- **assets/skills/**: static skill metadata and prompts
...
Rust-owned runtime surfaces expose skill inventory; Python does not host a local skill CLI.

### Project Structure
```
xiuxian-artisan-workshop/
├── assets/skills/             # Skill modules
├── packages/python/foundation/ # Shared Python helper layer
├── packages/python/core/       # Minimal retained compatibility/helpers
├── packages/python/test-kit/   # Transport and adapter verification
└── packages/python/xiuxian-wendao-py/ # Flight transport client
```"""
...
- **Shared library**: `packages/python/foundation/src/xiuxian_foundation/*.py`
