"""Tests for sys_query (Project Cerebellum) in xiuxian_cell.py."""
...
from omni.core.skills.runtime.xiuxian_cell import (
    ActionType,
    XiuxianCellRunner,
)


class TestXiuxianCellRunnerSysQuery:
    """Tests for XiuxianCellRunner.sys_query method."""

    @pytest_asyncio.fixture
    async def runner(self):
        """Create a runner for testing."""
        return XiuxianCellRunner()
