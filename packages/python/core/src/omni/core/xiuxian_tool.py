...
Usage:
    from omni.core.xiuxian_tool import get_xiuxian_tool_info, XIUXIAN_TOOL_DESCRIPTION
...
def get_xiuxian_tool_info() -> dict:
    """Get xiuxian tool metadata for registration.

    Returns:
        Dict with 'description' and 'inputSchema' keys.
    """
    return {
        "description": XIUXIAN_TOOL_DESCRIPTION,
        "inputSchema": XIUXIAN_INPUT_SCHEMA,
    }


def get_xiuxian_tool_list_entry() -> dict:
    """Get xiuxian tool entry for list_tools resource output.
