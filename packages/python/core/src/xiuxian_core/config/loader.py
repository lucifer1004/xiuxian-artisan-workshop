"""
xiuxian_core.config.loader - Configuration Loader
...
Usage:
    from xiuxian_core.config.loader import get_skill_limits, get_filter_commands, get_active_preload_skills
...
logger = get_logger("xiuxian_core.config")
...
def load_skill_limits() -> SkillLimitsConfig:
    ...
    try:
        from xiuxian_foundation.config.settings import get_settings
