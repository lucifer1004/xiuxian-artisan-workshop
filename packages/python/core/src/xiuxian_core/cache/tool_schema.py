"""
xiuxian_core.cache.tool_schema - Tool Schema Cache

Caches tool schemas with TTL support for performance optimization.

Usage:
    from xiuxian_core.cache.tool_schema import ToolSchemaCache, get_schema_cache
...
logger = get_logger("xiuxian_core.cache.tool_schema")
...
def get_schema_cache() -> ToolSchemaCache:
    ...
    if _schema_cache is None:
        ...
        try:
            from xiuxian_core.config.loader import load_skill_limits
