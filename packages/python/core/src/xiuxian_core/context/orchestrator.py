...
logger = get_logger("xiuxian_core.context.orchestrator")
...
def create_planner_orchestrator() -> ContextOrchestrator:
    """Create a minimal planner orchestrator for Rust-authoritative mode."""
...
def create_executor_orchestrator() -> ContextOrchestrator:
    """Create a minimal executor orchestrator for Rust-authoritative mode."""
    return ContextOrchestrator(
        [
...
def create_omni_loop_context() -> ContextOrchestrator:
    """Create the minimal Rust-authoritative orchestrator for the main loop."""
    return ContextOrchestrator(
        [
            SystemPersonaProvider(role="developer"),
        ]
