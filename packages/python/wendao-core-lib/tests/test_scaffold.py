...
from wendao_core_lib.scaffold import (
...
def test_scaffold_analyzer_plugin_generates_minimal_project_files() -> None:
    ...
    assert 'dependencies = ["wendao-core-lib"]' in files["pyproject.toml"]
    ...
    assert rows == [
        {
            "id": "symbol-1",
            "kind": "class",
            "path": "packages/python/wendao-core-lib/src/wendao_core_lib/transport/client.py",
            "score": 0.95,
        ...
        },
        {
            "id": "symbol-2",
            "kind": "function",
            "path": "packages/python/wendao-core-lib/src/wendao_core_lib/analyzer.py",
            "score": 0.9,
            "symbol": "run_analyzer",
        },
    ]
