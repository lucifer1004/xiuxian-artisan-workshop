...
```python
from xiuxian_wendao_py import repo_search_query
from xiuxian_wendao_py import repo_search_request
...
```python
from xiuxian_wendao_py import scaffold_analyzer_plugin, write_scaffold_project
...
```bash
xiuxian-wendao-scaffold ./acme-repo-search \
